...
```
python main.py eval_model_iou mini --modelf=./weight/efficientnet-b0-355c32eb.pth --dataroot=./nuScenes --gpuid=0
```
...
```
python main.py viz_model_preds mini --modelf=./weight/efficientnet-b0-355c32eb.pth --dataroot=./nuScenes --map_folder=./nuScenes/mini
```
...
```
python main.py train mini --dataroot=./nuScenes --logdir=./runs --gpuid=0
